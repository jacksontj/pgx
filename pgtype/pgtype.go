...
type ValueCreator func() Value

var NameValueCreators map[string]ValueCreator
...
func init() {
	...
	NameValueCreators = map[string]ValueCreator{
		"_aclitem":     func() Value { return &ACLItemArray{} },
		"_bool":        func() Value { return &BoolArray{} },
		"_bpchar":      func() Value { return &BPCharArray{} },
		"_bytea":       func() Value { return &ByteaArray{} },
		"_cidr":        func() Value { return &CIDRArray{} },
		"_date":        func() Value { return &DateArray{} },
		"_float4":      func() Value { return &Float4Array{} },
		"_float8":      func() Value { return &Float8Array{} },
		"_inet":        func() Value { return &InetArray{} },
		"_int2":        func() Value { return &Int2Array{} },
		"_int4":        func() Value { return &Int4Array{} },
		"_int8":        func() Value { return &Int8Array{} },
		"_numeric":     func() Value { return &NumericArray{} },
		"_text":        func() Value { return &TextArray{} },
		"_timestamp":   func() Value { return &TimestampArray{} },
		"_timestamptz": func() Value { return &TimestamptzArray{} },
		"_uuid":        func() Value { return &UUIDArray{} },
		"_varchar":     func() Value { return &VarcharArray{} },
		"aclitem":      func() Value { return &ACLItem{} },
		"bit":          func() Value { return &Bit{} },
		"bool":         func() Value { return &Bool{} },
		"box":          func() Value { return &Box{} },
		"bpchar":       func() Value { return &BPChar{} },
		"bytea":        func() Value { return &Bytea{} },
		"char":         func() Value { return &QChar{} },
		"cid":          func() Value { return &CID{} },
		"cidr":         func() Value { return &CIDR{} },
		"circle":       func() Value { return &Circle{} },
		"date":         func() Value { return &Date{} },
		"daterange":    func() Value { return &Daterange{} },
		"decimal":      func() Value { return &Decimal{} },
		"float4":       func() Value { return &Float4{} },
		"float8":       func() Value { return &Float8{} },
		"hstore":       func() Value { return &Hstore{} },
		"inet":         func() Value { return &Inet{} },
		"int2":         func() Value { return &Int2{} },
		"int4":         func() Value { return &Int4{} },
		"int4range":    func() Value { return &Int4range{} },
		"int8":         func() Value { return &Int8{} },
		"int8range":    func() Value { return &Int8range{} },
		"interval":     func() Value { return &Interval{} },
		"json":         func() Value { return &JSON{} },
		"jsonb":        func() Value { return &JSONB{} },
		"line":         func() Value { return &Line{} },
		"lseg":         func() Value { return &Lseg{} },
		"macaddr":      func() Value { return &Macaddr{} },
		"name":         func() Value { return &Name{} },
		"numeric":      func() Value { return &Numeric{} },
		"numrange":     func() Value { return &Numrange{} },
		"oid":          func() Value { return &OIDValue{} },
		"path":         func() Value { return &Path{} },
		"point":        func() Value { return &Point{} },
		"polygon":      func() Value { return &Polygon{} },
		"record":       func() Value { return &Record{} },
		"text":         func() Value { return &Text{} },
		"tid":          func() Value { return &TID{} },
		"timestamp":    func() Value { return &Timestamp{} },
		"timestamptz":  func() Value { return &Timestamptz{} },
		"tsrange":      func() Value { return &Tsrange{} },
		"tstzrange":    func() Value { return &Tstzrange{} },
		"unknown":      func() Value { return &Unknown{} },
		"uuid":         func() Value { return &UUID{} },
		"varbit":       func() Value { return &Varbit{} },
		"varchar":      func() Value { return &Varchar{} },
		"xid":          func() Value { return &XID{} },
	}
}
